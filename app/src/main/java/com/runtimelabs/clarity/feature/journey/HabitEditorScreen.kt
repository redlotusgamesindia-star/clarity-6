...
import com.runtimelabs.clarity.core.designsystem.components.ClarityDialogDefaults
import com.runtimelabs.clarity.core.designsystem.components.ClarityPrimaryButton
import com.runtimelabs.clarity.core.designsystem.components.clarityOutlinedTextFieldColors
import com.runtimelabs.clarity.core.designsystem.components.claritySwitchColors
...
fun HabitEditorScreen(
            ...
            if (state.isLoading) {
                ...
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        singleLine = true,
                        colors = clarityOutlinedTextFieldColors(),
    ...
    if (state.showDeleteDialog) {
        AlertDialog(
            ...
            shape = ClarityDialogDefaults.shape,
            containerColor = ClarityDialogDefaults.containerColor,
            titleContentColor = ClarityDialogDefaults.titleContentColor,
            textContentColor = ClarityDialogDefaults.textContentColor,
...
private fun TimePickerDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Surface(
            shape = ClarityDialogDefaults.shape,
            color = ClarityDialogDefaults.containerColor,
            tonalElevation = 6.dp,
        ) {
